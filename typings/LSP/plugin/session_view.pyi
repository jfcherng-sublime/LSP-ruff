import sublime
from ..protocol import Command as Command, DiagnosticSeverity as DiagnosticSeverity, DocumentUri as DocumentUri
...
class SessionView:
    ...
    def _draw_diagnostics(self, severity: DiagnosticSeverity, max_severity_level: int, flags: sublime.RegionFlags, multiline: bool) -> None: ...
