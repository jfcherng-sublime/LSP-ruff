...
from ..protocol import CodeAction as CodeAction, Command as Command, Diagnostic as Diagnostic, DocumentLink as DocumentLink, Hover, Position as Position, Range as Range
from .code_actions import filter_quickfix_actions as filter_quickfix_actions
from .core.constants import HOVER_ENABLED_KEY as HOVER_ENABLED_KEY, MarkdownLangMap as MarkdownLangMap, RegionKey as RegionKey, SHOW_DEFINITIONS_KEY as SHOW_DEFINITIONS_KEY
...
class LspHoverCommand(LspTextCommand):
    ...
    _actions_by_config: dict[str, list[Command | CodeAction]]
    ...
    def _handle_code_actions(self, listener: AbstractViewListener, point: int, responses: list[tuple[str, list[Command | CodeAction]]]) -> None: ...
