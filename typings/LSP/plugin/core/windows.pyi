...
from ..api import AbstractPlugin as AbstractPlugin, IsApplicableContext as IsApplicableContext, LspPlugin as LspPlugin, OnPreStartContext as OnPreStartContext, PluginStartError as PluginStartError, get_plugin as get_plugin
...
from .sessions import AbstractViewListener as AbstractViewListener, Logger as Logger, Manager as Manager, Session as Session
...
from .types import ClientConfig as ClientConfig, ViewStatusHandler as ViewStatusHandler, matches_pattern as matches_pattern, sublime_pattern_to_glob as sublime_pattern_to_glob
...
class WindowManager(Manager, WindowConfigChangeListener, ViewStatusHandler):
    ...
    _view_statuses: dict[int, dict[str, str]]
