import sublime
from ...protocol import AnnotatedTextEdit, Position as Position, SnippetTextEdit, TextEdit, WorkspaceEdit as WorkspaceEdit
...
WorkspaceChanges = dict[str, tuple[list[TextEdit | AnnotatedTextEdit | SnippetTextEdit], str | None, int | None]]
...
def apply_text_edits(view: sublime.View, edits: Sequence[TextEdit | AnnotatedTextEdit | SnippetTextEdit], *, label: str | None = None, process_placeholders: bool = False, required_view_version: int | None = None) -> Promise[sublime.View | None]: ...
