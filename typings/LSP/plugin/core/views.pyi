...
from ...protocol import CodeAction as CodeAction, CodeActionContext as CodeActionContext, CodeActionKind as CodeActionKind, CodeActionParams as CodeActionParams, Color as Color, ColorInformation as ColorInformation, Command as Command, Diagnostic as Diagnostic, DiagnosticRelatedInformation as DiagnosticRelatedInformation, DiagnosticSeverity, DiagnosticTag as DiagnosticTag, DidChangeTextDocumentParams as DidChangeTextDocumentParams, DidCloseTextDocumentParams as DidCloseTextDocumentParams, DidOpenTextDocumentParams as DidOpenTextDocumentParams, DidSaveTextDocumentParams as DidSaveTextDocumentParams, DocumentColorParams as DocumentColorParams, DocumentFormattingParams as DocumentFormattingParams, DocumentHighlightKind as DocumentHighlightKind, DocumentRangeFormattingParams as DocumentRangeFormattingParams, DocumentRangesFormattingParams as DocumentRangesFormattingParams, DocumentUri, FormattingOptions as FormattingOptions, LanguageKind as LanguageKind, Location as Location, LocationLink as LocationLink, MarkedString as MarkedString, MarkupContent as MarkupContent, Position as Position, Range as Range, SelectionRangeParams as SelectionRangeParams, TextDocumentContentChangeEvent as TextDocumentContentChangeEvent, TextDocumentIdentifier as TextDocumentIdentifier, TextDocumentItem as TextDocumentItem, TextDocumentPositionParams as TextDocumentPositionParams, TextDocumentSaveReason as TextDocumentSaveReason, TextEdit as TextEdit, VersionedTextDocumentIdentifier as VersionedTextDocumentIdentifier, WillSaveTextDocumentParams as WillSaveTextDocumentParams
from .constants import CODE_ACTION_KINDS as CODE_ACTION_KINDS, MARKO_MD_PARSER_VERSION as MARKO_MD_PARSER_VERSION, MarkdownLangMap as MarkdownLangMap, ST_CACHE_PATH as ST_CACHE_PATH, ST_PLATFORM as ST_PLATFORM, ST_STORAGE_PATH as ST_STORAGE_PATH, SUBLIME_KIND_SCOPES as SUBLIME_KIND_SCOPES, SublimeKind as SublimeKind
...
def did_change_text_document_params(view: sublime.View, version: int, changes: list[sublime.TextChange] | None = None) -> DidChangeTextDocumentParams: ...
...
def did_change(view: sublime.View, version: int, changes: list[sublime.TextChange] | None = None) -> Notification[DidChangeTextDocumentParams]: ...
...
def text_document_code_action_params(view: sublime.View, region: sublime.Region, diagnostics: list[Diagnostic], only_kinds: list[str | CodeActionKind] | None = None, manual: bool = False) -> CodeActionParams: ...
...
def format_diagnostics_for_html(view: sublime.View, diagnostics_by_config: Sequence[tuple[SessionBufferProtocol, Sequence[Diagnostic]]], code_actions_by_config: dict[str, list[Command | CodeAction]], lightbulb_color: str, base_dir: str | None = None) -> str: ...
def format_diagnostic_for_html(view: sublime.View, config: ClientConfig, diagnostic: Diagnostic, code_actions: list[Command | CodeAction], lightbulb_color: str, base_dir: str | None = None) -> str: ...
