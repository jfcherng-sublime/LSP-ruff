...
class LspRenamePathCommand(LspWindowCommand):
    ...
    def create_will_rename_requests_async(self, file_rename: FileRename) -> Generator[Promise[tuple[WorkspaceEdit | Error | None, weakref.ref[Session]]]]: ...
    def return_response_with_session(self, weak_session: weakref.ref[Session], response: WorkspaceEdit | Error | None) -> tuple[WorkspaceEdit | Error | None, weakref.ref[Session]]: ...
    def handle_rename_async(self, responses: list[tuple[WorkspaceEdit | Error | None, weakref.ref[Session]]], label: str, rename_command_args: dict[str, Any]) -> None: ...
